...
import com.techchefs.empmanage.EmployeeDAOFactory;
...
public class EmployeeSearchServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(!bean.isEmpty()) {
			...
			out.print("<div class=\"search col-2\"><form action=\"http://localhost:80/empmanage/search\"> <input type=\"text\" placeholder=\"Search\" name=\"search\"/></div></form>         ");
			...
			for(EmployeeInfoBean b : bean) {
				out.print("<div class=\"data-display\"><a href=\"./result?id="+b.getId()+"\" >"+b.getName()+" </a></div>");
			}
			out.print("</div> ");
			out.print("</body>");
			out.print("</html>");
