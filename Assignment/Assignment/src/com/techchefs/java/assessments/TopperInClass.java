...
public class TopperInClass {
	...
	public static void main(String[] args) {
		...
		arrayList.add(new Student(9, "james", 75.50,"male"));
		arrayList.add(new Student(1, "jane", 60.00,"female"));
		arrayList.add(new Student(7, "tom", 87.00,"male"));
		arrayList.add(new Student(5, "anna", 48.00,"Female"));
