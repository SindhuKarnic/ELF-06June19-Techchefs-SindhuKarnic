...
public class StudentSortTest {
	...
	public static void main(String[] args) {
		...
		Student s2 = new Student(9, "tom", 75.50,"male");
		Student s3 = new Student(1, "anna", 60.00,"female");
		Student s4 = new Student(7, "sarah", 87.00,"female");
		Student s5 = new Student(5, "james", 48.00,"male");
