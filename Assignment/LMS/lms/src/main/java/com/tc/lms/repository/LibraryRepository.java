...
import com.tc.lms.dto.UserRegisterBean;


public interface LibraryRepository extends CrudRepository<UserRegisterBean,Integer> {
	...
	public List<UserRegisterBean> searchById(@Param("user_id") int userId);
}
